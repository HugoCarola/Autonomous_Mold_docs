...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52833DK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_W5500_TIMEOUT, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_LOG_LEVEL_DBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_BUF_RX_COUNT, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_BUF_TX_COUNT, 10);
